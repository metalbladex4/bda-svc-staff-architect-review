...
- Raw source: `model_cards/gemma4_31b_hf.html`
...
[Model card](/google/gemma-4-31B-it)

[FilesFiles and versionsxet](/google/gemma-4-31B-it/tree/main)

[Community71](/google/gemma-4-31B-it/discussions)
...
Downloads last month 3,513,465
...
## Model tree for google/gemma-4-31B-it/docs/hub/model-cards#specifying-a-base-model

Adapters

[50 models](/models?other=base_model:adapter:google/gemma-4-31B-it)

Finetunes

[92 models](/models?other=base_model:finetune:google/gemma-4-31B-it)

Merges

[1 model](/models?other=base_model:merge:google/gemma-4-31B-it)

Quantizations

/models?apps=llama.cpp&other=base_model:quantized:google/gemma-4-31B-it/models?apps=lmstudio&other=base_model:quantized:google/gemma-4-31B-it/models?apps=jan&other=base_model:quantized:google/gemma-4-31B-it/models?apps=ollama&other=base_model:quantized:google/gemma-4-31B-it
[146 models](/models?other=base_model:quantized:google/gemma-4-31B-it)

## Spaces using google/gemma-4-31B-it 100

[🚀huggingface-projects/gemma-4-31b-it](/spaces/huggingface-projects/gemma-4-31b-it)

[👀FINAL-Bench/Darwin-31B-Opus](/spaces/FINAL-Bench/Darwin-31B-Opus)

[🧭Flickinshots/EmailMaestro](/spaces/Flickinshots/EmailMaestro)

[🐢xuxuxu8052/google-gemma-4-31B-it](/spaces/xuxuxu8052/google-gemma-4-31B-it)

[📚eduagarcia/multilingual-tokenizer-leaderboard](/spaces/eduagarcia/multilingual-tokenizer-leaderboard)

[🚀pratyushjdhv/mocktest](/spaces/pratyushjdhv/mocktest)

[🐢HPAI-BSC/TuRTLe-Leaderboard](/spaces/HPAI-BSC/TuRTLe-Leaderboard)

[👀FINAL-Bench/Gemma-4-Multi](/spaces/FINAL-Bench/Gemma-4-Multi)

## Collection including google/gemma-4-31B-it
...
- MathArena Aime 2026 on [MathArena/aime_2026](https://huggingface.co/datasets/MathArena/aime_2026) [View evaluation results](/google/gemma-4-31B-it/discussions/6) [leaderboard](/datasets/MathArena/aime_2026?eval_result=google/gemma-4-31B-it)

89.2

- Diamond on [Idavidrein/gpqa](https://huggingface.co/datasets/Idavidrein/gpqa) [View evaluation results](/google/gemma-4-31B-it/discussions/5) [leaderboard](/datasets/Idavidrein/gpqa?eval_result=google/gemma-4-31B-it)
...
on [cais/hle](https://huggingface.co/datasets/cais/hle) [View evaluation results](/google/gemma-4-31B-it/discussions/5)
...
- Mmlu Pro on [TIGER-Lab/MMLU-Pro](https://huggingface.co/datasets/TIGER-Lab/MMLU-Pro) [View evaluation results](/google/gemma-4-31B-it/discussions/5)
