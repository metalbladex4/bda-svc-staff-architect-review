...
- Raw source: `model_cards/gemma4_e2b_hf.html`
- Source URL: https://huggingface.co/google/gemma-4-E2B
...
[Any-to-Any](/models?pipeline_tag=any-to-any)
...
[image-text-to-text](/models?other=image-text-to-text)

[Model card](/google/gemma-4-E2B)

[FilesFiles and versionsxet](/google/gemma-4-E2B/tree/main)

[Community4](/google/gemma-4-E2B/discussions)
...
[Any-to-Any](/tasks/any-to-any)

This model isn't deployed by any Inference Provider. [🙋14Ask for provider support](/spaces/huggingface/InferenceSupport/discussions/9015)

## Model tree for google/gemma-4-E2B/docs/hub/model-cards#specifying-a-base-model

Adapters

[3 models](/models?other=base_model:adapter:google/gemma-4-E2B)

Finetunes

[16 models](/models?other=base_model:finetune:google/gemma-4-E2B)

Quantizations

[24 models](/models?other=base_model:quantized:google/gemma-4-E2B)

## Spaces using google/gemma-4-E2B 2

[😻jsmanrique/license-cat-analyzer](/spaces/jsmanrique/license-cat-analyzer)

[🔬Carnot-EBM/hallucination-detector](/spaces/Carnot-EBM/hallucination-detector)
