...
- Raw source: `model_cards/gemma4_26b_a4b_hf.html`
- Source URL: https://huggingface.co/google/gemma-4-26B-A4B-it
...
[Transformers](/models?library=transformers)

[Safetensors](/models?library=safetensors)

[gemma4](/models?other=gemma4)

[conversational](/models?other=conversational)

[Eval Results](/models?other=eval-results)

[Model card](/google/gemma-4-26B-A4B-it)

[FilesFiles and versionsxet](/google/gemma-4-26B-A4B-it/tree/main)

[Community29](/google/gemma-4-26B-A4B-it/discussions)
...
Downloads last month 2,562,020
...
## Model tree for google/gemma-4-26B-A4B-it/docs/hub/model-cards#specifying-a-base-model

Adapters

[37 models](/models?other=base_model:adapter:google/gemma-4-26B-A4B-it)

Finetunes

[50 models](/models?other=base_model:finetune:google/gemma-4-26B-A4B-it)

Merges

[1 model](/models?other=base_model:merge:google/gemma-4-26B-A4B-it)

Quantizations

/models?apps=llama.cpp&other=base_model:quantized:google/gemma-4-26B-A4B-it/models?apps=lmstudio&other=base_model:quantized:google/gemma-4-26B-A4B-it/models?apps=jan&other=base_model:quantized:google/gemma-4-26B-A4B-it/models?apps=ollama&other=base_model:quantized:google/gemma-4-26B-A4B-it
[132 models](/models?other=base_model:quantized:google/gemma-4-26B-A4B-it)

## Spaces using google/gemma-4-26B-A4B-it 45

[📦pcuenq/gemma-4-object-detection](/spaces/pcuenq/gemma-4-object-detection)

[👀FINAL-Bench/Gemma-4-Multi](/spaces/FINAL-Bench/Gemma-4-Multi)

[🐠Mohitrai11/DeepDub](/spaces/Mohitrai11/DeepDub)

[🚀huggingface-projects/gemma-4-26b-a4b-it](/spaces/huggingface-projects/gemma-4-26b-a4b-it)

[📦Yash030/AI-Package-Doctor](/spaces/Yash030/AI-Package-Doctor)

[🏆beta3/Gemma_Hub_Explorer](/spaces/beta3/Gemma_Hub_Explorer)

[🩸yatin-superintelligence/pathology-env](/spaces/yatin-superintelligence/pathology-env)

[⚡SvsDhanush/photo-dec-api](/spaces/SvsDhanush/photo-dec-api)

## Collection including google/gemma-4-26B-A4B-it

####

[Gemma 4Collection8 items•Updated15 days ago•634](/collections/google/gemma-4)

## Evaluation results https://huggingface.co/docs/hub/eval-results

- Mean on [llamaindex/ParseBench](https://huggingface.co/datasets/llamaindex/ParseBench) [View evaluation results](/google/gemma-4-26B-A4B-it/discussions/29)

[source](https://huggingface.co/datasets/llamaindex/ParseBench) [leaderboard](/datasets/llamaindex/ParseBench?eval_result=google/gemma-4-26B-A4B-it)

58.5 *

- Text Content on [llamaindex/ParseBench](https://huggingface.co/datasets/llamaindex/ParseBench) [View evaluation results](/google/gemma-4-26B-A4B-it/discussions/29)

[source](https://huggingface.co/datasets/llamaindex/ParseBench) [leaderboard](/datasets/llamaindex/ParseBench?eval_result=google/gemma-4-26B-A4B-it)

83.8 *

- Text Formatting on [llamaindex/ParseBench](https://huggingface.co/datasets/llamaindex/ParseBench) [View evaluation results](/google/gemma-4-26B-A4B-it/discussions/29)

[source](https://huggingface.co/datasets/llamaindex/ParseBench) [leaderboard](/datasets/llamaindex/ParseBench?eval_result=google/gemma-4-26B-A4B-it)

65.1 *

- Layout on [llamaindex/ParseBench](https://huggingface.co/datasets/llamaindex/ParseBench) [View evaluation results](/google/gemma-4-26B-A4B-it/discussions/29)

[source](https://huggingface.co/datasets/llamaindex/ParseBench) [leaderboard](/datasets/llamaindex/ParseBench?eval_result=google/gemma-4-26B-A4B-it)

59.2 *

- Chart on [llamaindex/ParseBench](https://huggingface.co/datasets/llamaindex/ParseBench) [View evaluation results](/google/gemma-4-26B-A4B-it/discussions/29)

[source](https://huggingface.co/datasets/llamaindex/ParseBench) [leaderboard](/datasets/llamaindex/ParseBench?eval_result=google/gemma-4-26B-A4B-it)

14.2 *

- Table on [llamaindex/ParseBench](https://huggingface.co/datasets/llamaindex/ParseBench) [View evaluation results](/google/gemma-4-26B-A4B-it/discussions/29)

[source](https://huggingface.co/datasets/llamaindex/ParseBench) [leaderboard](/datasets/llamaindex/ParseBench?eval_result=google/gemma-4-26B-A4B-it)

70 *

- MathArena Aime 2026 on [MathArena/aime_2026](https://huggingface.co/datasets/MathArena/aime_2026) [View evaluation results](/google/gemma-4-26B-A4B-it/discussions/5) [leaderboard](/datasets/MathArena/aime_2026?eval_result=google/gemma-4-26B-A4B-it)

88.3

- Diamond on [Idavidrein/gpqa](https://huggingface.co/datasets/Idavidrein/gpqa) [View evaluation results](/google/gemma-4-26B-A4B-it/discussions/3) [leaderboard](/datasets/Idavidrein/gpqa?eval_result=google/gemma-4-26B-A4B-it)
...
on [cais/hle](https://huggingface.co/datasets/cais/hle) [View evaluation results](/google/gemma-4-26B-A4B-it/discussions/3)
