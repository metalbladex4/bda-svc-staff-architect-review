...
inputs = processor(text=texts, images=image, return\_tensors="pt")
...
results = processor.post\_process\_object\_detection(outputs=outputs, target\_sizes=target\_sizes, threshold=0.1)
