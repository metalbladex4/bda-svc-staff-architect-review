...
pipeline\_tag: zero-shot-object-detection
...
<img src="https://huggingface.co/datasets/huggingface/documentation-images/resolve/main/transformers/model\_doc/grouding\_dino\_architecture.png"
...
inputs = processor(images=image, text=text, return\\\_tensors="pt").to(device)
